class Wall:
    ...
    def __str__(self):
        return "Material is '{}', height = {} ft.".format(self.material, self.height)
...
class Apartment:
    ...
    def __str__(self):
        return "The adress is '{}' St' {}, walls {}, furniture=[\n{}]".format(
            self.street,
            self.apartment_no,
            self.walls,
...
if __name__ == '__main__':
    furniture = [Furniture("bed", 150), Furniture("cupboard", 250), Furniture("table", 35), Furniture("armchair", 80)]
    flat1 = Apartment("Bronco", 3050, "brick", 23, furniture)
    print("\nInformation about the first apartment:", flat1)
    print("Total furniture cost is {}$\n".format(
        flat1.get_total_furniture_cost()))
